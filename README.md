...
#EXTINF:-1 tvg-id="GAZI TV (BD)" tvg-name="GAZI TV (BD)"  tvg-logo="https://i.imgur.com/NcgtFek.png" group-title=" ADULT / SPORTS CHANNELS",GAZI TV (BD)
...
#EXTINF:-1 tvg-id="SONY SAB HD (IN)" tvg-name="SONY SAB HD (IN)"tvg-logo="https://i.ytimg.com/vi/em5ay4irr2s/maxresdefault.jpg"group-title="ENTERTAINMENT / MOVIES CHANNELS",SONY SAB HD (IN) VPN
